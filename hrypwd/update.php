<?php 
	...
	if ( !empty($_POST)) {
		...
		// update data here
			...
			$sql = "UPDATE camp_donor_information  set 
			name_of_donor = ? ,
			address_of_donor = ?,
			city = ?,
			state = ?,
			...
			$q->execute([$name_of_donor,$address_of_donor,$city,$state,$pin_code,$date_of_birth,$mobile_number,$email_id,$id]);
			Database::disconnect();
                  ...
                  <div class="card-body">
                     <div id="UpdatePanel1">
                        <div class="row">
                           ...
                           <div class="col">
                              <center>
                                 <h4><b>Update Donor Registration</b></h4>
                              </center>
                           </div>
                        </div>
                        <div class="row">
                        ...
                        <form method="post" action="#">
                           <div class="row">
                              <div class="col-md-6">
								...
								<div class="form-group <?php echo !empty($name_of_donorError)?'error':'';?>">
								<label class="control-label">Name of Donor</label>
								<div class="controls">
									<input name="name_of_donor" type="text"  placeholder="Enter Name of Donor" class="form-control" value="<?php echo !empty($data['name_of_donor'])?$data['name_of_donor']:$name_of_donor;?>">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group <?php echo !empty($email_idError)?'error':'';?>">
									...
									<div class="controls">
										<input name="email_id" type="email"  placeholder="Enter Email" class="form-control" value="<?php echo !empty($data['email_id'])?$data['email_id']:$email_id;?>">
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group <?php echo !empty($date_of_birthError)?'error':'';?>">
									...
									<div class="controls">
										<input name="date_of_birth" type="date"  placeholder="Enter date of birth" class="form-control" value="<?php echo !empty($data['date_of_birth'])?$data['date_of_birth']:$date_of_birth;?>">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group <?php echo !empty($mobile_numberError)?'error':'';?>">
									...
									<div class="controls">
										<input name="mobile_number" type="number"  placeholder="Enter Contact Number" class="form-control" value="<?php echo !empty($data['mobile_number'])?$data['mobile_number']:$mobile_number;?>">
								   ...
								   <label class="control-label">State</label>			
									...
									<div class="controls">
												...
												<select id="state" class="form-control" name="state">
												   <option value="0" <?php if(!empty($data['state']) && $data['state'] == 0 || $state == 0){ echo "selected"; } ?> >Select State</option>
												  <option value="Haryana" <?php if(!empty($data['state']) && $data['state'] == 'Haryana' || $state =='Haryana'){ echo "selected"; } ?> >Haryana</option>
												</select>
                                  ...
                                  <div class="form-group <?php echo !empty($cityError)?'error':'';?>">
									...
									<div class="controls">
											...
											<select id="city" class="form-control" name="city">
												<option value="0" <?php if(!empty($data['city']) && $data['city'] == 0 || $city = 0){ echo "selected"; } ?> >Select Cith</option>
												<option value="Panchkula" <?php if(!empty($data['city']) &&  $data['city'] == 'Panchkula' || $city = 'Panchkula'){ echo "selected"; } ?>>Panchkula</option>
												<option value="Ambala" <?php if(!empty($data['city']) &&  $data['city'] == 'Ambala' || $city = 'Ambala'){ echo "selected"; } ?>>Ambala</option>
											</select>
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                <div class="form-group <?php echo !empty($pin_codeError)?'error':'';?>">
										...
										<div class="controls">
											<input name="pin_code" type="text"  placeholder="Enter Pincode" class="form-control" value="<?php echo !empty($data['pin_code'])?$data['pin_code']:$pin_code;?>">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group <?php echo !empty($donorAdError)?'error':'';?>">
									...
									<div class="controls">
									<textarea name="address_of_donor" class="form-control"><?php echo !empty($data['address_of_donor'])?$data['address_of_donor']:$address_of_donor?></textarea>
